...
init(){
  ...
  ;; Run yasb
  ;Run "python.exe .\Projects\yasb\src\main.py", ,"Hide"
  ...
  for num in numbers{
    runwait("komorebic workspace-padding 0 " . num . " 2",,"hide")
    RunWait("komorebic container-padding 0 " . num . " 6",,"Hide")
  }

  ;; Window border
  ;Run "komorebic.exe active-window-border enable", ,"Hide"
  ;Run "komorebic.exe active-window-border-colour 20 120 240 --window-kind stack", ,"Hide"
}
